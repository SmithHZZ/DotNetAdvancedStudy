namespace _22_EntityFramework_CodeFirst
{
    ...
    public partial class Colp_Equipment_List
    {
        [StringLength(36)]
        ...
        [StringLength(36)]
        public string Current_Check_Id { get; set; }

        [StringLength(196)]
        public string Current_Check_Name { get; set; }

        [StringLength(40)]
        public string Current_Check_Code { get; set; }
