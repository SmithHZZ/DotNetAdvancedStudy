...
namespace _22_EntityFramework_DBFirst
{
    ...
    public partial class Colp_Operation_Detail
    {
        ...
        public Nullable<short> MensesCleanDays { get; set; }
        public string AblationMode { get; set; }
        public Nullable<short> PositionLenth1 { get; set; }
        public Nullable<short> PositionLenth2 { get; set; }
        public Nullable<short> PositionLenth3 { get; set; }
        public Nullable<short> PositionWidth1 { get; set; }
        public Nullable<short> PositionWidth2 { get; set; }
        public Nullable<short> PositionWidth3 { get; set; }
        public Nullable<short> VegetationsLenth { get; set; }
        public Nullable<short> VegetationsWidth { get; set; }
        public Nullable<short> VegetationsHeight { get; set; }
        public string CutMode { get; set; }
        public Nullable<short> CutLenth { get; set; }
        public Nullable<short> CutWidth { get; set; }
        public Nullable<short> CutHeight { get; set; }
        public Nullable<short> OperateTime { get; set; }
        public Nullable<short> Bloody { get; set; }
        public Nullable<short> Bloodyloss { get; set; }
        public Nullable<short> CutPerimeter { get; set; }
    }
}
