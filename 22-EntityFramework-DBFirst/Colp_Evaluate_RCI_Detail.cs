...
namespace _22_EntityFramework_DBFirst
{
    ...
    public partial class Colp_Evaluate_RCI_Detail
    {
        ...
        public Nullable<int> BoundaryNum { get; set; }
        public string Colour { get; set; }
        public Nullable<int> ColourNum { get; set; }
        public string Bloodvessel { get; set; }
        public Nullable<int> BloodvesselNum { get; set; }
        public string Iodinestaining { get; set; }
        public Nullable<int> IodinestainingNum { get; set; }
        public Nullable<int> SumAppraisesCore { get; set; }
        public string RCIAppraiseResult { get; set; }
        public Nullable<System.DateTime> RCIAppraiseDate { get; set; }
